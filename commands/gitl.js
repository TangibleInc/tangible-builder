...
module.exports = function devCommand(config) {
  ...
  try {
    ...
    gitlibConfig = require(path.join(cwd, localConfigFileName))
    console.log('Config:', localConfigFileName)
  } catch(e) {
    try {
      gitlibConfig = require(path.join(cwd, configFileName))
  ...
  case 'tag': {
    ...
    break
  default:
    console.log('Usage: gitl [command] [module name (optional)]\n')
